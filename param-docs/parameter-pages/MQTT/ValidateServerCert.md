...
If `disabled (false)`, the ESP32 skips all validation of the server certificate.<br>
...
!!! Note
    ...
    If you use a public broker, it is recommended to set this parameter to `enabled (true)`.
